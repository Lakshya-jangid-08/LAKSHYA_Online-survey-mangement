...
const ProfileCard = () => {
  ...
  if (error) {
    return (
      <div className="bg-gradient-card border border-primary-200 shadow-lg rounded-lg p-6 max-w-md mx-auto">
  ...
  return (
    <div className="bg-gradient-card border border-primary-200 shadow-lg rounded-lg overflow-hidden max-w-md mx-auto transition-all duration-300 hover:shadow-md">
      {/* Header with accent color */}
      <div className="bg-primary-100 h-24"></div>
      ...
      <div className="relative px-6 py-8">
        ...
        <div className="absolute -top-12 left-1/2 transform -translate-x-1/2">
          <div className="bg-white rounded-full p-2 shadow-md">
            <div className="bg-primary-100 rounded-full p-4 flex items-center justify-center">
