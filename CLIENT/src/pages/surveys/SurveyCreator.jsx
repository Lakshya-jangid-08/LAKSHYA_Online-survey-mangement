  ...
  return (
    <div className="min-h-screen bg-gradient-subtle py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="bg-gradient-card border border-primary-200 shadow-lg sm:rounded-lg">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    type="button"
                    onClick={addQuestion}
                    className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-lg text-primary-700 bg-primary-100 hover:bg-primary-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
                  >
                ...
                {formData.questions.map((question, index) => (
                  <div key={index} className="bg-gradient-subtle p-4 rounded-lg">
                          ...
                          {question.choices.map((choice, optionIndex) => (
                            <div key={optionIndex} className="flex items-center space-x-2">
                              <input
                                ...
                                className="flex-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
